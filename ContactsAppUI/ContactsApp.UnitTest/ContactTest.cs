...
namespace ContactsApp.UnitTests
{
	...
	public class ContactTest
	{
		...
		public void TestSernameSet_ArgumentException(string wrongSername, string message)
		{
			Assert.Throws<ArgumentException>(
			() => { _contact.Sername = wrongSername; },
			message);
		}
		...
		public void Test_Sername_Set_CorrectValue(string rightSername, string massage)
		{
			Assert.DoesNotThrow(
				() => { _contact.Sername = rightSername; },
				massage);
		}
		...
		public void Test_SecondName_Get_CorrectValue()
		{
			...
			var expected = "Ivanov";
			_contact.Sername = expected;
			//Возвращаемое значение
			var actual = _contact.Sername;
